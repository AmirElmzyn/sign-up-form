...
const firstName = document.querySelector('input[placeholder="First Name"]') as HTMLInputElement;
const lastName = document.querySelector('input[placeholder="Last Name"]') as HTMLInputElement;
const email = document.querySelector('input[type="email"]') as HTMLInputElement;
const password = document.querySelector('input[type="password"]') as HTMLInputElement;

function showError(input: HTMLInputElement, customMessage: string | null = null): void {
    const parent = input.parentElement!;
    const errorIcon = parent.querySelector(".error-icon") as HTMLElement;
    const errorMes = parent.querySelector(".error-mes") as HTMLElement;
